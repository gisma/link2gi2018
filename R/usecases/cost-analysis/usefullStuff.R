...
accuCalc <- function (dem="dem",cost="cost",currentP=NULL,lambda=0.5,memory=4000,walk=walk){
  cat ('calculate accumulated costs for point:',unlist(currentP),"\n")
  ...
  if (walk) {
    cat ('calculate walk cost for point:',unlist(currentP),"\n")
